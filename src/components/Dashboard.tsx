import { ArrowRight, BookOpen, Check, Flame, Grid3X3, Headphones, Image, LockKeyhole, MessageSquareText, Quote, Search, Shuffle, Sparkles, Star, Zap } from 'lucide-react'
...
export function Dashboard({ profile, progress, today, environment, words, onNavigate, onGame, onEnvironment }: Props) {
  ...
  const dailyDone = progress.dailyCompleted === today
    ...
    <div className="dashboard page-enter">
      <section className="welcome-row">
        <div>
          ...
          <h1>A little practice, {learnerName}?</h1>
          <p>Your next {language.name} word is waiting.</p>
        </div>
